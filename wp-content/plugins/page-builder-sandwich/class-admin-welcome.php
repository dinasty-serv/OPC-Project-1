		...
		public function create_admin_page() {
			...
			<div class="wrap about-wrap">
				...
				<div class="welcome-panel pbs-welcome-changelog">
					...
					<ul>
<li style="color: #f39c12"><code>Change</code> Removed HelpScout Beacon</li>
<li style="color: #f39c12"><code>Enhanced</code> Updated Freemius SDK to v2.3.2</li>
<li style="color: #e74c3c"><code>Fixed</code> Save and cancel buttons unclickable</li>
<li style="color: #e74c3c"><code>Fixed</code> PHP 7.3 compatibility</li>
<li style="color: #e74c3c"><code>Fixed</code> Media manager styling</li>
<li style="color: #e74c3c"><code>Fixed</code> Help button now opens the documentation site</li>
<li style="color: #e74c3c"><code>Fixed</code> Alignment of top buttons</li>
					</ul>
				</div>
			</div>
			<?php
