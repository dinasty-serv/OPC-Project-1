...
= 4.5.3 =
* Change: Removed HelpScout Beacon
* Enhanced: Updated Freemius SDK to v2.3.2
* Fixed: Save and cancel buttons unclickable
* Fixed: PHP 7.3 compatibility
* Fixed: Media manager styling
* Fixed: Help button now opens the documentation site
* Fixed: Alignment of top buttons
