<?php
	...
	if($vw_hotel_first_color != false){
		$vw_hotel_custom_css .='.search-box i, #slider .carousel-control-prev-icon, #slider .carousel-control-next-icon, .more-btn a, .overlay-bttn a, input[type="submit"], .footer .tagcloud a:hover, .footer-2, .scrollup i, .sidebar input[type="submit"], .sidebar .tagcloud a:hover, .blogbutton-small, .pagination span, .pagination a, nav.woocommerce-MyAccount-navigation ul li, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce span.onsale, #comments a.comment-reply-link, .toggle-nav i, a.button, .sidebar .widget_price_filter .ui-slider .ui-slider-range, .sidebar .widget_price_filter .ui-slider .ui-slider-handle, .sidebar .woocommerce-product-search button, .footer .widget_price_filter .ui-slider .ui-slider-range, .footer .widget_price_filter .ui-slider .ui-slider-handle, .footer .woocommerce-product-search button, .footer a.custom_read_more, .sidebar a.custom_read_more, .footer .custom-social-icons i:hover, .sidebar .custom-social-icons i:hover{';
			$vw_hotel_custom_css .='background-color: '.esc_html($vw_hotel_first_color).';';
		$vw_hotel_custom_css .='}';
	}
	if($vw_hotel_first_color != false){
	...
	if($vw_hotel_first_color != false){
		$vw_hotel_custom_css .='.footer .custom-social-icons i, .sidebar .custom-social-icons i, .footer .custom-social-icons i:hover, .sidebar .custom-social-icons i:hover{';
			$vw_hotel_custom_css .='border-color: '.esc_html($vw_hotel_first_color).';';
		$vw_hotel_custom_css .='}';
	}
	if($vw_hotel_first_color != false){
		$vw_hotel_custom_css .='hr.hrclass, .woocommerce-info, .main-navigation ul ul{';
			$vw_hotel_custom_css .='border-top-color: '.esc_html($vw_hotel_first_color).';';
		$vw_hotel_custom_css .='}';
	}
	if($vw_hotel_first_color != false){
		$vw_hotel_custom_css .='.main-navigation ul ul, .header-fixed{';
			$vw_hotel_custom_css .='border-bottom-color: '.esc_html($vw_hotel_first_color).';';
		$vw_hotel_custom_css .='}';
	}
	if($vw_hotel_first_color != false){
	...
	if($vw_hotel_slider_height != false){
		$vw_hotel_custom_css .='#slider img{';
			$vw_hotel_custom_css .='height: '.esc_html($vw_hotel_slider_height).';';
		$vw_hotel_custom_css .='}';
	}
	...
	$vw_hotel_resp_metabox = get_theme_mod( 'vw_hotel_metabox_hide_show',true);
    if($vw_hotel_resp_metabox == true){
    	$vw_hotel_custom_css .='@media screen and (max-width:575px) {';
		$vw_hotel_custom_css .='.post-info{';
			$vw_hotel_custom_css .='display:block;';
		$vw_hotel_custom_css .='} }';
	}else if($vw_hotel_resp_metabox == false){
		$vw_hotel_custom_css .='@media screen and (max-width:575px) {';
		$vw_hotel_custom_css .='.post-info{';
			$vw_hotel_custom_css .='display:none;';
		$vw_hotel_custom_css .='} }';
    ...
    if($vw_hotel_resp_scroll_top == true){
		...
		$vw_hotel_custom_css .='@media screen and (max-width:575px) {';
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='display:none !important;';
		$vw_hotel_custom_css .='} }';
	}
	...
	if($vw_hotel_sticky_header_padding != false){
		$vw_hotel_custom_css .='.header-fixed{';
			$vw_hotel_custom_css .='padding: '.esc_html($vw_hotel_sticky_header_padding).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_search_padding_top_bottom != false || $vw_hotel_search_padding_left_right != false || $vw_hotel_search_font_size != false || $vw_hotel_search_border_radius != false){
		$vw_hotel_custom_css .='.search-box i{';
			$vw_hotel_custom_css .='padding-top: '.esc_html($vw_hotel_search_padding_top_bottom).'; padding-bottom: '.esc_html($vw_hotel_search_padding_top_bottom).';padding-left: '.esc_html($vw_hotel_search_padding_left_right).';padding-right: '.esc_html($vw_hotel_search_padding_left_right).';font-size: '.esc_html($vw_hotel_search_font_size).';border-radius: '.esc_html($vw_hotel_search_border_radius).'px;';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_button_padding_top_bottom != false || $vw_hotel_button_padding_left_right != false){
		$vw_hotel_custom_css .='.blogbutton-small{';
			$vw_hotel_custom_css .='padding-top: '.esc_html($vw_hotel_button_padding_top_bottom).'; padding-bottom: '.esc_html($vw_hotel_button_padding_top_bottom).';padding-left: '.esc_html($vw_hotel_button_padding_left_right).';padding-right: '.esc_html($vw_hotel_button_padding_left_right).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_button_border_radius != false){
		$vw_hotel_custom_css .='.blogbutton-small, .hvr-sweep-to-right:before{';
			$vw_hotel_custom_css .='border-radius: '.esc_html($vw_hotel_button_border_radius).'px;';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_copyright_alingment != false){
		$vw_hotel_custom_css .='.copyright p{';
			$vw_hotel_custom_css .='text-align: '.esc_html($vw_hotel_copyright_alingment).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_copyright_padding_top_bottom != false){
		$vw_hotel_custom_css .='.footer-2{';
			$vw_hotel_custom_css .='padding-top: '.esc_html($vw_hotel_copyright_padding_top_bottom).'; padding-bottom: '.esc_html($vw_hotel_copyright_padding_top_bottom).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_scroll_to_top_font_size != false){
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='font-size: '.esc_html($vw_hotel_scroll_to_top_font_size).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_scroll_to_top_padding != false){
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='padding-top: '.esc_html($vw_hotel_scroll_to_top_padding).';padding-bottom: '.esc_html($vw_hotel_scroll_to_top_padding).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_scroll_to_top_width != false){
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='width: '.esc_html($vw_hotel_scroll_to_top_width).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_scroll_to_top_height != false){
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='height: '.esc_html($vw_hotel_scroll_to_top_height).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_scroll_to_top_border_radius != false){
		$vw_hotel_custom_css .='.scrollup i{';
			$vw_hotel_custom_css .='border-radius: '.esc_html($vw_hotel_scroll_to_top_border_radius).'px;';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_social_icon_font_size != false){
		$vw_hotel_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hotel_custom_css .='font-size: '.esc_html($vw_hotel_social_icon_font_size).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_social_icon_padding != false){
		$vw_hotel_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hotel_custom_css .='padding: '.esc_html($vw_hotel_social_icon_padding).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_social_icon_width != false){
		$vw_hotel_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hotel_custom_css .='width: '.esc_html($vw_hotel_social_icon_width).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_social_icon_height != false){
		$vw_hotel_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hotel_custom_css .='height: '.esc_html($vw_hotel_social_icon_height).';';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_social_icon_border_radius != false){
		$vw_hotel_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hotel_custom_css .='border-radius: '.esc_html($vw_hotel_social_icon_border_radius).'px;';
		$vw_hotel_custom_css .='}';
	}