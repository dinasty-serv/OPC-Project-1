...
<?php if(get_theme_mod('vw_hotel_loader_enable',true)==1){ ?>
  <div id="preloader">
    <div id="status">
      <?php $vw_hotel_theme_lay = get_theme_mod( 'vw_hotel_loader_icon','Two Way');
        if($vw_hotel_theme_lay == 'Two Way'){ ?>
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/two-way.gif" alt="" role="img"/>
      <?php }else if($vw_hotel_theme_lay == 'Dots'){ ?>
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/dots.gif" alt="" role="img"/>
      <?php }else if($vw_hotel_theme_lay == 'Rotate'){ ?>
