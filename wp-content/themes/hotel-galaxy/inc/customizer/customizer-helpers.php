...
require_once trailingslashit( dirname( __FILE__ ) ) . 'controls/class-room-category-dropdown-control.php';

require_once trailingslashit( dirname( __FILE__ ) ) . 'controls/class-customizer-title-control.php';
